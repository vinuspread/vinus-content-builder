...
5. 전체 길이는 2500~4000자. 절대 2500자 미만으로 쓰지 않는다
...
주의:
- 카드뉴스 문장을 그대로 옮기지 마세요.
- 각 카드의 핵심 개념을 독자가 처음 접하는 것처럼 배경과 이유를 충분히 설명하세요.
- 카드뉴스에 없는 수치, 사례, 효과를 임의로 추가하지 마세요. 원본에 있는 정보만 사용하세요.
- 실무에서 어떻게 적용할 수 있는지 구체적으로 서술하세요.
- 전체 2500자 이상이 되어야 합니다.`
}
