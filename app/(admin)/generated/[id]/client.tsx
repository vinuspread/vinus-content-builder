...
export function GeneratedDetailClient({ content: initial }: { content: GeneratedContent }) {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      {/* 캐릭터 */}
      {(content.character_ment || content.character_visual) && (
        <div className="space-y-3">
          <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">캐릭터</p>
          {content.character_ment && (
            <div className="rounded-xl border bg-card px-4 py-3 ring-1 ring-foreground/5">
              <p className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground mb-1">멘트</p>
              <p className="text-sm font-medium leading-relaxed">&ldquo;{content.character_ment}&rdquo;</p>
            </div>
          )}
          {content.character_visual && (
            <div className="rounded-xl border bg-card px-4 py-3 ring-1 ring-foreground/5">
              <p className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground mb-1">비주얼 지시</p>
              <p className="text-sm text-muted-foreground leading-relaxed whitespace-pre-line">{content.character_visual}</p>
            </div>
          )}
        </div>
      )}
